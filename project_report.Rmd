...
```{r intro_data_visualization, fig.width=12, fig.height=8}
...
```
This introductory figure from data in policekillings in part demonstrates our interest in exploring this topic. As evident from the figure, police killings  impacted every single American state to some degree in 2015. Consequently, we felt compelled to better understand the demographics behind these numbers.

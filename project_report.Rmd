...
This introductory figure, from our chosen "policekillings" dataset, motivates our group to explore this topic. As evident from the figure, police killings  impacted every single American state to some degree in 2015. Consequently, we felt compelled to better understand the demographics behind these numbers.

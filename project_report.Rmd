...
GENERAL QUESTION: How do demographic factors differ amongst those who have been killed by the police?
...
*talk about test statistic?

PROPORTION BY GENDER - STAT SIGNIFICANT THAT MORE MEN KILLED
```{r}
police_killings %>% 
...
NOW TESTING FOR THE CORRELATION BETWEEN THESE TWO VARIABLES
```{r}
police_killings %>%
...
```{r}
model_1 <- lm(pov ~ raceethnicity + gender, data = police_killings)
model_1 %>%
  tidy() %>%
